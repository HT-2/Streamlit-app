...
Original file is located at
    https://colab.research.google.com/drive/1dbWaACNei1gAbo924K25UXJlYpwYrx8g
"""

import subprocess
import sys

subprocess.check_call([sys.executable, "-m", "pip", "install", "haystack-ai"])
subprocess.check_call([sys.executable, "-m", "pip", "install", "datasets>=2.6.1"])
...
subprocess.check_call([sys.executable, "-m", "pip", "install", "google-ai-haystack"])
